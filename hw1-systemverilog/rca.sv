...
module rca4(input wire [3:0]  a,
    ...
    wire c1, c2, c3;
    fulladder1 fa0(.cin(1'b0), .a(a[0]), .b(b[0]), .s(sum[0]), .cout(c1));
    fulladder1 fa1(.cin(c1),   .a(a[1]), .b(b[1]), .s(sum[1]), .cout(c2));
    fulladder1 fa2(.cin(c2),   .a(a[2]), .b(b[2]), .s(sum[2]), .cout(c3));
    fulladder1 fa3(.cin(c3),   .a(a[3]), .b(b[3]), .s(sum[3]), .cout(carry_out));
endmodule
